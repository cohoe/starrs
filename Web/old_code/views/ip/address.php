...
<div class="item_container">
	...
	<div class="item_lower_bar_style2">Created on <?echo $address->get_date_created();?> - Modified by <?echo $address->get_last_modifier();?> on <?echo $address->get_date_modified();?></div>
</div>
