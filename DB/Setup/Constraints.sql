...
ALTER TABLE "dns"."queue" ADD CONSTRAINT "fk_queue_info" FOREIGN KEY ("hostname","address","zone") REFERENCES "dns"."a"("hostname","address","zone") MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE ;
