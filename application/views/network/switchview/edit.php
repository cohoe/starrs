<div class="item_container">
	<form method="POST" class="input_form">
	    <label for="community">SNMP RO: </label><input type="text" name="ro_community" value="<?echo $sys->get_ro_community();?>" class="input_form_input" /><br />
        <label for="community">SNMP RW: </label><input type="text" name="rw_community" value="<?echo $sys->get_rw_community();?>" class="input_form_input" /><br />
