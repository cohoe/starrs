<div class="item_container">
	<form method="POST" class="input_form">
	    <label for="ro_community">SNMP RO Community: </label><input type="text" name="ro_community" class="input_form_input" /><br />
        <label for="rw_community">SNMP RW Community: </label><input type="text" name="rw_community" class="input_form_input" /><br />
