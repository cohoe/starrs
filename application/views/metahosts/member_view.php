<div class="item_container">
	<div class="interface_box">
		<div class="interface_box_nav">
			...
			<a href="/firewall/metahost_members/delete/<?echo rawurlencode($membr->get_name())."/".rawurlencode($membr->get_address());?>"><div class="nav_item_right"><span>Delete</span></div></a>
		</div>
		<div class="infobar">
