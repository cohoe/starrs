<div class="item_container">
		...
		Address Records (A, AAAA)
			<table class="dns_information_area_table">
				...
				<tr>
					...
					<td><?echo $address->get_address_record()->get_ttl();?></td>
					<td><?echo $address->get_address_record()->get_last_modifier();?></td>
	...
	<?} if($address->get_pointer_records()) {?>
		...
		<table class="dns_information_area_table">
			<tr><th>Alias</th><th>Target</th><th>Extra</th><th>Type</th><th>TTL</th><th>Last Modifier</th><th>Delete</th></tr>
			<? foreach ($address->get_pointer_records() as $pointer) { ?>
				<tr>
					...
					<td><?echo $pointer->get_ttl();?></td>
					<td><?echo $pointer->get_last_modifier();?></td>
				</tr>
			<?}?>
		</table>
		</div>
	<?} if($address->get_text_records()) {?>
		...
		<table class="dns_information_area_table">
			<tr><th>Text</th><th>TTL</th><th>Last Modifier</th><th>Delete</th></tr>
	...
	<?} if($address->get_ns_records()) {?>
		...
		<table class="dns_information_area_table">
			<tr><th>Zone</th><th>Primary</th><th>TTL</th><th>Last Modifier</th><th>Delete</th></tr>
			<? foreach ($address->get_ns_records() as $ns) { ?>
			<tr>
				<td><?echo $ns->get_zone();?></td>
				<td><?echo $ns->get_isprimary();?></td>
				<td><?echo $ns->get_ttl();?></td>
				<td><?echo $ns->get_last_modifier();?></td>
	...
	<?} if($address->get_mx_records()) {?>
		...
		<table class="dns_information_area_table">
			<tr><th>Preference</th><th>TTL</th><th>Last Modifier</th><th>Delete</th></tr>
