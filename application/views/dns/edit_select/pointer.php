<div class="item_information_area_container">
	...
	<table class="dns_information_area_table">
		...
		<? foreach ($records as $record) {
			...
			echo "<td><a href=\"/dns/edit/".rawurlencode($record->get_address())."/".rawurlencode($record->get_type())."/".rawurlencode($record->get_zone())."/".rawurlencode($record->get_hostname)()."/".rawurlencode($record->get_alias())."\">E</a></td>";
			echo "</tr>";
		}?>
	</table>
</div>